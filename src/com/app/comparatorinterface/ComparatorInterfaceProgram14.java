...
public class ComparatorInterfaceProgram14 {
	public static void main(String[] args) {
		...
		ToLongFunction<Employee> ageToLongFunction = (employee)->employee.getAge();
		
		Comparator<Employee> thenAgeAscComparator = enameAscComparator.thenComparingLong(ageToLongFunction);
